...
public class Problem_1518 {
	 ...
	 * you can drink: 9 + 3 + 1 = 13. Example 2:
	 * 
	 * 
	...
	public static void main(String args[]) {
		System.out.println(numWaterBottles(9, 3)); // Expected 13
		System.out.println(numWaterBottles(15, 4)); // Expected 19
	...
	public static int numWaterBottles(int numBottles, int numExchange) {
		...
		while (currentBottle >= numExchange) {
			int swap = currentBottle / numExchange;
			result += swap;
			currentBottle = (currentBottle % numExchange) + swap;
		}
		return result;
