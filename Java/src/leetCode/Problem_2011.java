...
public class Problem_2011 {
	 ...
	 * by 1, X = 0 + 1 = 1. Example 2:
	 * 
	 * Input: operations = ["++X","++X","X++"] Output: 3 Explanation: The operations
	 * are performed as follows: Initially, X = 0. ++X: X is incremented by 1, X = 0
	 * + 1 = 1. ++X: X is incremented by 1, X = 1 + 1 = 2. X++: X is incremented by
	 * 1, X = 2 + 1 = 3. Example 3:
	 * 
	 * Input: operations = ["X++","++X","--X","X--"] Output: 0 Explanation: The
	 * operations are performed as follows: Initially, X = 0. X++: X is incremented
	 * by 1, X = 0 + 1 = 1. ++X: X is incremented by 1, X = 1 + 1 = 2. --X: X is
	 * decremented by 1, X = 2 - 1 = 1. X--: X is decremented by 1, X = 1 - 1 = 0.
	 * 
	 * 
	 * Constraints:
	 * 
	 * 1 <= operations.length <= 100 operations[i] will be either "++X", "X++",
	 * "--X", or "X--".
	 */
	...
	public static int finalValueAfterOperations(String[] operations) {
        ...
        for (String string : operations) {
			if(string.equals("X++") || string.equals("++X")) result++;
			else {
				result--;
			}
		}
